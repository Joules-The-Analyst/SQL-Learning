...
-- -- CASTING A COLUMN IN SQL (THIS TEMPORARILY CHANGES THE DATA TYPE)
...
-- -- TEXT DATA IN SQL...WE HAVE CATEGORICAL AND UNSTRUCTURED
...
-- -- -- WORKING ON MULTIPLE TRANSFORMATIONS
